        ...
        <div className="inline-block m-4 p-4 h-screen">
            ...
            <section>
                <div className="justify-center border-spacing-96 border-2 border-lime-600 dark:border-lime-700 rounded-3xl p-4 my-4">
                    ...
                    />
                    <br />
                    {globalErrors.LOGIN?.error ? <text className="text-red-500">{globalErrors.LOGIN.error}</text> : null}
                    <br />
                    ...
                    <h4 className="border-t-2 border-lime-600 dark:border-lime-700 dark:text-gray-200">Aun no tienes cuenta?</h4>
                    <h4 className="dark:text-gray-200">Registrate</h4>
                    <Link to="/register-user">
                        <button className="bg-gray-200 dark:bg-gray-800 rounded-3xl p-2 mr-1 mt-1 dark:text-gray-300">Usuario</button>
                    </Link>
                    <Link to="/register-company">
                        <button className="bg-gray-200 dark:bg-gray-800 rounded-3xl p-2 ml-1 mt-1 dark:text-gray-300">Empresa</button>
                    </Link>
                </div>
            </section>
        </div>
