...
const LandingPage = () => {
  ...
  return (
    <main className="items-center flex flex-col justify-center text-center  h-full ">
      ...
      <section className="w-full  bg-light-1  p-2 pb-16 text-center ">
        ...
        <iframe
          ...
          className="h-[250px] lg:h-[600px] rounded xl:w-[1200px] lg:w-[1100px] md:w-[700px] md:h-[500px] m-auto w-[360px]     "
        ></iframe>
      </section>
      ...
      <section className="w-full bg-light-1 m-auto ">
        <h1
